...
(function ($) {
  new ImageViewer(document.querySelector("#resume-picture-mine")); // check options section for supported options
  console.log(document.querySelector("#resume-picture-mine"));
  ("use strict");
